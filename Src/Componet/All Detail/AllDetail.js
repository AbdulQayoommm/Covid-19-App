    ...
    render() {
        ...
        return (
            <View>
                ...
                {/* Confirmed Cases */}
                <Card style={{ width: 270, marginLeft: 50 ,borderRadius: 30 }}>
                    <CardItem style={{ backgroundColor: '#5F9EA0' ,borderRadius: 30 }}>
                        <Body>
                            ...
                            <Text style={{ alignSelf: 'center', fontWeight: 'bold', fontSize: 30 }}>{this.state.confirmed}</Text>
                        </Body>
                    </CardItem>
                </Card>
                ...
                <Card style={{ width: 270, marginLeft: 50 ,borderRadius: 30 }}>
                    <CardItem style={{ backgroundColor: '#FA8072',borderRadius: 30 }}>
                        <Body>
                            ...
                            <Text style={{ alignSelf: 'center', fontWeight: 'bold', fontSize: 30 }}>{this.state.deaths}</Text>
                        </Body>
                    </CardItem>
                </Card>
                ...
                <Card style={{ width: 270, marginLeft: 50 ,borderRadius: 30 }}>
                    <CardItem style={{ backgroundColor: '#BC8F8F',borderRadius: 30  }}>
                        <Body>
                            ...
                            <Text style={{ alignSelf: 'center', fontWeight: 'bold', fontSize: 30 }}>{this.state.recovered}</Text>
                        </Body>
                    </CardItem>
                </Card>
            </View>
